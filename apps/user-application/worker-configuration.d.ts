/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env --env stage` (hash: 0b88326a39cbeea6ec842bc560f868ce)
...
declare namespace Cloudflare {
	...
	interface Env {
		MY_VAR: "Hello from Cloudflare" | "Hello from Cloudflare Production";
		...
		POLAR_SECRET: string;
		DB: D1Database;
		BACKEND_SERVICE: Fetcher /* saas-kit-data-service-stage */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "VITE_BASE_HOST" | "CLOUDFLARE_ENV" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "POLAR_SECRET">> {}
}
